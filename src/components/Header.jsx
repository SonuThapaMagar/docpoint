    ...
    return (
        <div className='flex flex-col md:flex-row bg-violet-400 rounded-lg px-6 md:px-10 lg:px-20 items-center'>
            ...
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-6 py-10 md:py-[5vw]'>
                ...
                <a href="#" className="flex items-center gap-2 text-gray-600 font-medium bg-gray-100 px-8 py-3 rounded-full text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300">
                    Book Appointment
